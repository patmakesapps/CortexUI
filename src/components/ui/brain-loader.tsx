    ...
    <div className={className}>
      <div className="inline-flex items-center gap-5 pl-1">
        <div className="relative flex h-14 w-14 items-center justify-center">
          <motion.div
            className="absolute inset-0 rounded-full bg-cyan-300/35 blur-[2px]"
            animate={{ opacity: outerOpacity, scale: outerScale }}
            transition={{ duration, repeat: Infinity, ease: "easeInOut" }}
          />
          <motion.div
            className="absolute inset-1 rounded-full border border-cyan-200/35"
          ...
          />
          <motion.div
            className="absolute inset-2 rounded-full bg-cyan-200/10"
          ...
          >
            <Image
              ...
              alt=""
              aria-hidden="true"
              className="h-10 w-10 object-contain opacity-100 [filter:brightness(0)_invert(1)_sepia(1)_saturate(520%)_hue-rotate(170deg)_drop-shadow(0_0_14px_rgba(125,211,252,1))]"
            />
          </motion.div>
        </div>
